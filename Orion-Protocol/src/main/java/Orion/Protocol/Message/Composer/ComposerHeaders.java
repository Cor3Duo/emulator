...
public abstract class ComposerHeaders {
    ...
    public static int ResponseGroupCreationInfoComposer = 2159;
    public static int ResponseGroupBadgesComposer = 2402;
    public static int GroupElementsComposer = 2238;
}
