...
import Orion.Protocol.Message.Composer.Room.Settings.RoomSettingsDataComposer;
import Orion.Protocol.Message.Event.EventHeaders;
import com.google.inject.Singleton;

@Singleton
public class RequestRoomSettingsEvent implements IMessageEventHandler {
    @Override
    public int getId() {
        return EventHeaders.RequestRoomSettingsEvent;
    }
