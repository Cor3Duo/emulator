...
import Orion.Protocol.Message.Composer.Room.Settings.RoomBannedListComposer;
import Orion.Protocol.Message.Event.EventHeaders;
import com.google.inject.Singleton;

@Singleton
public class RoomBannedListEvent implements IMessageEventHandler {
    @Override
    public int getId() {
        return EventHeaders.RoomBannedListEvent;
    }
    ...
    public void handle(IMessageEvent event, ISession session) {
        ...
        session.send(new RoomBannedListComposer(room));
    }
}
